...
model = load_model('Sign-Language-To-Text-and-Speech-Conversion/cnn8grps_rad1_model.h5')
white = np.ones((400, 400), np.uint8) * 255
cv2.imwrite("Sign-Language-To-Text-and-Speech-Conversion/white.jpg", white)
